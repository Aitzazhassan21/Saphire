...
const Product = () => {
  ...
  return productData ? (
    <div className='px-4 sm:px-[2vw] md:px-[3vw] lg:px-[4vw] pt-10 transition-opacity duration-500 ease-in border-t-2 opacity-100'>
      {/* Product Data */}
      <div className='flex flex-col gap-12 sm:gap-12 sm:flex-row'>
        ...
        <div className='flex-1'>
          ...
          <button 
            onClick={() => addToCart(productData._id, 'Fixed')} 
            className='px-8 py-3 mt-8 text-sm text-white bg-black active:bg-gray-700'
          >
            ADD TO CART
          </button>
